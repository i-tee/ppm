 ...
 *    бэк-минт прошёл, а старый INSERT в Joomla упал. Фонового ретрая/алерта
 *    пока НЕТ (в планах) — сейчас повтор делает сам партнёр тем же кодом;
 *  - в планах: источник для UI-списков новых купонов (O2 плана) без чтения
 *    купонов с бэка. Сейчас журнал только пишется, UI его не читает.
 */
