        ...
        https:
            command === "serve"
                ? {
                      key: fs.readFileSync(
                          path.resolve(
                              "/home/dev-user/conf/web/partner.avicenna.com.ru/ssl/partner.avicenna.com.ru.key",
                          ),
                      ),
                      cert: fs.readFileSync(
                          path.resolve(
                              "/home/dev-user/conf/web/partner.avicenna.com.ru/ssl/partner.avicenna.com.ru.pem",
                          ),
                      ),
                  }
                : undefined,
