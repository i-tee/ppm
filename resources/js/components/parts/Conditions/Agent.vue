    ...
    <div class="content">
      <section class="mb-8">
        ...
        <p>
          ...
          новых клиентов.
          Зарегистрировавшись в программе, вы получаете доступ к инструментам для создания промокодов и отслеживания
          статистики.
        </p>
        <p>
      ...
      <section class="mb-8">
        ...
        <ul>
          <li><strong>Общую скидку (X%)</strong> — максимальный лимит устанавливается компанией ({{ maxDiscount }}%).
          </li>
          <li>
        ...
        <div class="example example-rule">
        ...
        <ul>
          <li>Номинал такого промокода для клиента должен быть на {{ bonusPercentage }}% ВЫШЕ, чем сумма, списанная с
            вашего счёта</li>
