  ...
  <div class="max-w-4xl mx-auto px-4 py-8 text-gray-800">
    ...
    <div class="space-y-10">
      ...
      <section>
        ...
        <h3 class="text-xl font-semibold mt-6 mb-2">3. Настройка промокода <span>(🤗 самое интересное)</span></h3>
        ...
        <div class="bg-yellow-50 border-l-4 border-yellow-300 p-4 my-4">
          <p><strong>ВАЖНО! Именно Вы определяете долю своей прибыли!</strong> Можете оставить {{ partnerDiscountPercent
          }}%
            себе, и сделать скидку любимому клиенту в размере {{ partnerDiscountPercent }}%. Поделить пополам или в
            любых других
            пропорциях.</p>
          <p>😉 <b class="text-yellow-600">Создайте много промокодов для разных ситуаций</b></p>
        </div>

        <div style="padding: 20px; margin: -40px 0 0 0;">
          <VaSlider color="warning" v-model="clientDiscountPercent" :min="0" :max="maxDiscountPercent" :step="1"
            size="2rem" />
        </div>
        ...
        <h3 class="text-xl font-semibold mt-6 mb-2">9. Выплаты вознаграждения</h3>
        <p class="mb-2">
          Заявки на вывод средств рассматриваются и одобряются вручную. Деньги перечисляются строго
          <strong>по пятницам</strong>.
        </p>
        <ul class="list-disc pl-6 space-y-1">
          <li>После одобрения заявки ожидайте поступления платежа в <strong>ближайшую рабочую пятницу</strong>.</li>
          <li>Ели пятница выпадает на праздничный день, выплата производится в <strong>следующую рабочую
              пятницу</strong>.</li>
          <li>Компания работает только по будням; обработка заявок и выплаты осуществляются исключительно в рабочие дни.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <h3 class="text-xl font-semibold mt-6 mb-2">Ограничения по применению промокода</h3>
        <ul class="list-disc pl-6 space-y-1">
          <li>В один заказ можно активировать <strong>только один промокод</strong>.</li>
          <li>Скидка по промокоду рассчитывается <strong>персонально на каждый товар в корзине</strong>.</li>
          <li>Скидка распространяется <strong>только на товары без перечёркнутой старой цены</strong> (товары, не
            участвующие в акции).</li>
          <li>Если товар уже имеет акционную цену, скидка по промокоду на него <strong>не распространяется</strong>.
          </li>
          <li>Ваш кешбэк (партнёрская доля) начисляется <strong>с полной суммы заказа без учёта акционных
              позиций</strong> и всегда поступает на бонусный счёт, даже если в корзине были только акционные товары.
          </li>
        </ul>
