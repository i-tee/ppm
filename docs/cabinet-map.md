...
| 1.2 | Фронт: стор настроек/профиля, свежий профиль, без лишних запросов, ленивые экраны | 7, 8 | промпт готов |
| 1.2б | Сервер: пакетные запросы в Joomla, кеш `business-data` 60 с (разрешено владельцем 25.09) | 8 | промпт готов |
